...
exports.create = async(req, res) => {
  ...
  const insertQuery = `INSERT INTO users (first_name, last_name, email, password, is_deleted) VALUES ('${req.body.first_name}', '${req.body.last_name}', '${req.body.email}', '${req.body.hashedPassword}', '0')`;
  // Execute the query
